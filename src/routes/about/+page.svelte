...
<main class="mt-15 mr-1 ml-1 min-h-screen">
	...
	<section class="container mx-auto mt-15 mb-25">
		<div class="min-w-full">
			...
			<br />
			<p class="fade-up-o mb-2 leading-[2.2rem] text-lg">
			...
			<p class="fade-up-o leading-[2.2rem] text-lg">
				<!---->
				さて、そんな楽しい楽しい桐朋祭が今年度も開催されます！開催日時は、6/6(土) 12:00～17:00、6/7(日) 9:30～17:00、6/8(月) 9:30～13:30 です。さあ、桐朋祭であなたも、桐朋生の"本気"を体感せよ！！！
			</p>
			<br />
			<hr class="main-hr" />
			<br />
